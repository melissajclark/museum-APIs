...
artApp.displayPieces = function(pieces) {
	...
	$.ajax({
		...
		success: function(result) {  // when the ajax request comes back - run this code! (another word for success = callback)
			...
			var img = "<a href='" + artPiece.webImage.url + "data-featherlight='image' class='artImageLink'><img class='artImage lazy' data-original='" + artPiece.webImage.url + "'" + "src='" + artPiece.webImage.url + "'></a>";
